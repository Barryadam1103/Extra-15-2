...
$(document).ready( () => {
    $( "#save" ).click( () => {
        ...
        //const sess_storage = [];
        //sess_storage[0] = ["email"];
        //sess_storage[1] = ["phone"];
        //sess_storage[2] = ["zip"];
        //sess_storage[3] = ["dob"];
        ...
        const json = JSON.stringify(sess_storage);
        sessionStorage.sess_storage = json;
        sessionStorage.setItem("profile", JSON.stringify(sess_storage));
